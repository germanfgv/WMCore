...
config.RetryManager.MemoryModifier.default.requiresModify = True
config.RetryManager.MemoryModifier.default.maxMemory = 20 # in GB
config.RetryManager.MemoryModifier.default.addedMemory = 2 # in GB
